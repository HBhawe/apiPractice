...
const renderResult = function (result) {
    const markup = `<p class="title">Address:</p><p>${result.resolvedAddress}</p><p class="title">Latitude:</p> <p>${result.latitude}</p><p class="title">Longitude:</p><p>${result.longitude}</p><p class="title">Description:</><p>${result.description}</p><p class="title">Current Temperature:</p><p>${result.currentConditions.temp} \u00B0 C</p>`;
